...
| `log_demanda_talleres.csv` | Log de talleres "próximamente" solicitados por usuarios |
...
| `.gitignore` | Exclusiones de Git (protege el `.env` con tokens) |
...
- **Bot en vivo:** [@SDIH_asesor_bot](https://t.me/SDIH_asesor_bot) en Telegram
